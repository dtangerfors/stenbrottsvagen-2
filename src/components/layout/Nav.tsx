...
function NavPill(props: any) {
  return (
    <Link
      to={props.to}
      className="flex-1 h-[4.5rem] flex flex-col justify-center text-sm leading-8 text-gray-400 text-center bg-gray-50 hover:bg-gray-100 transition-all ease-in-out duration-200 dark:bg-black-700 dark:hover:bg-black-600 first:rounded-l-2xl last:rounded-r-2xl"
...
function Nav({openPopup}: any) {
  return (
    <nav className="fixed z-20 bottom-0 left-0 flex justify-center w-full pt-6 px-8 pb-safeBottom bg-white border-gray-100 border-t dark:bg-black-800 dark:border-black-600">
      <NavPill to="/app/hem">
