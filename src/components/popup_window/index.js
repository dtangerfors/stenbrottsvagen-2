      ...
      {popupForm.isOpen && (
        ...
        >
          ...
          <div className="w-full p-8 pb-safeBottom">
            ...
            <BookingForm key="booking-form" userID={user.uid} onBookingComplete={onBookingComplete} popupForm={popupForm} closePopup={closePopup} buttonText={popupData.button}/>
          </div>
        </motion.div>
        <Overlay key="overlay" />
        </>
