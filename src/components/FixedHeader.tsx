...
export default function FixedHeader({children, invisibleFromStart}: any) {
  ...
  return (
    <MobileView>
      <header className={`fixed w-full mb-8 z-20 top-0 pt-safe-top px-8 bg-secondary transition-all duration-300 ${invisibleFromStart ? 'opacity-0' : 'opacity-100'}`} ref={headerRef}>
